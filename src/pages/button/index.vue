<template>
    <div class="container">
        <div class="doc__title wuli-hairline__bottom">BUTTON</div>
        <div class="doc-description">按钮</div>
        <div class="wuli-panel__title">普通按钮</div>
        <div class="wuli-panel">
            <div class="wuli-btns">
                <wp-button type="normal">默认按钮</wp-button>
        ...
        <div class="wuli-panel" style="padding: 15px;">
            ...
            <wp-button type="primary" size="small">主要按钮</wp-button>
        </div>
        ...
        <div class="wuli-panel" style="padding: 15px;">
            ...
            <wp-button type="warn" size="mini">警告按钮</wp-button>
            <wp-button type="danger" size="mini">危险按钮</wp-button>
        </div>
